...
public class GetAggregatedAccessLogsForPatientTeststubMuleServer {

	public static final String MULE_SERVER_ID = "GetAggregatedAccessLogsForPatient-teststub";

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedAccessLogsForPatientTeststubMuleServer.class);
