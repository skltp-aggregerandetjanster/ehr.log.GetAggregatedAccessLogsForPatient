...
public class GetAggregatedLogsForPatientTeststubMuleServer {

	public static final String MULE_SERVER_ID = "GetAggregatedLogsForPatient-teststub";

	private static final Logger logger = LoggerFactory.getLogger(GetAggregatedLogsForPatientTeststubMuleServer.class);
