package se.skltp.aggregatingaccesslogsforpatient;
...
public class AccessLogsForPatientMuleServer {

    private static final Logger logger = LoggerFactory.getLogger(AccessLogsForPatientMuleServer.class);
    private static final RecursiveResourceBundle rb = new RecursiveResourceBundle("GetAggregatedLogsForPatient-config");
    ...
    public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually loads all a*-service.xml files that are specified in the file "src/main/app/mule-deploy.properties"
        //
